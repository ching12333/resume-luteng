...
//  此文件仅包含简历内容数据（INIT_ELEMENTS）
//  编辑器保存时只更新此文件，不影响编辑器代码
//  更新编辑器时只需替换 editor.js / editor.css，不影响此数据
// ============================================================
